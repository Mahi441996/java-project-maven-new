        ...
        <div class="card-container">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h6 class="des">Lorem Hello ipsum dolor sit consectetur elit.</h6>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h6 class="des">Sailaja hello ipsum dolor sit consectetur elit.</h6>
                    <button class="watchlist-btn">add to watchlist</button>
                </div>
            </div>
            <div class="card">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h6 class="des">Khush Hii dolor hello consectetur elit.</h6>
                    <button class="watchlist-btn">add to watchlist</button>
                </div>
            </div>
            <div class="card">
